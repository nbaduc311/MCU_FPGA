...
#define SPI0_EN			0	//e2
#define I2C0_EN			1	//e3 - I2C0: SCL->P0.10 (opt2), SDA->P0.11 (opt2)
#define CT16B0_EN		1	//e4 - CT16B0 PWM0 -> P3.0 (buzzer)
...
#define PFPA_I2C0_VAL			  0x0000000A  // SCL0->P0.10 (opt2), SDA0->P0.11 (opt2)
#define PFPA_CT16B0_VAL		  0x00000001  // PWM0 (opt1) -> P3.0 (buzzer)
